...
public class PeripheralBase:NSObject, PeripheralProtocol, CBPeripheralDelegate
{
    ...
    private func peripheral(_ peripheral: CBPeripheral, didReadRSSI RSSI: NSNumber, error: Error?) {
    ...
    private func peripheralDidUpdateRSSI(_ peripheral: CBPeripheral, error: Error?) {
