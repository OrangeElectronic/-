...
class Glitter {
    constructor() {
        ...
        this.setHome = function (url, tag, obj) {
            ...
            $('#framePlace').empty();
            $('#framePlace').append('<iframe  style="" name="' + map.id + '" src="' + url + '?tag=' + tag + '&pageIndex=' + map.pageIndex + '&type=Page"  id="' + map.pageIndex + '"></iframe>');
        ...
        * */
        ...
        this.downloadFile = function (serverRout, fileName, timeOut, callBack) {
            ...
            switch (glitter.deviceType) {
                ...
                case appearType.Android:
                {
                    glitter.runJsInterFace("FileDonload",{
                        serverRout:serverRout,
                        fileName:fileName,
                        timeOut:timeOut
                    },function (response){
