...
import static com.orango.electronic.orange_og_lib.Util.OggUtils.hideKeyBoard;

/**
 * 带清除按钮的EditText
 * Created by haide.yin() on 2019/1/23 15:38.
 */
public class Util_ClearEditText extends AppCompatEditText implements View.OnFocusChangeListener, TextWatcher {
    public com.orango.electronic.orange_og_lib.Callback.textchange textchange=null;
     ...
     */
    public Util_ClearEditText(Context context, AttributeSet attrs) {
...
//                spannableString.setSpan(new ForegroundColorSpan(Color.parseColor(txtColor)), start, start+1, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
    ...
    public void beforeTextChanged(CharSequence s, int start, int count, int after) {
        hideKeyBoard(JzActivity.Companion.getControlInstance().getRootActivity());
    }
