...
class Glitter {
    constructor() {
        ...
        this.openDiaLog = function (url, tag, swipe, cancelable, obj, dismiss) {
            if (glitter.dialog.filter(function (item) {return item.id === 'Dialog-' + tag;}).length !== 0) {return;}
            glitter.pageIndex += 1;
            var map = {};
            map.pageIndex = glitter.pageIndex;
            map.id = 'Dialog-' + tag;
        ...
        this.goBack = function () {
            ...
            try {
                document.getElementById(glitter.iframe[index].pageIndex).contentWindow.reSetKeyBoardUtel();
        ...
        this.closeApp = function () {
            ...
            switch (glitter.deviceType) {
                case appearType.Android:
                    glitter.runJsInterFace("closeAPP",{},function (){})
                    break;
                case appearType.Ios:
