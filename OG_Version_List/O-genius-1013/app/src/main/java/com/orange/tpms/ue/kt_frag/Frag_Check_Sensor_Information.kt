...
class Frag_Check_Sensor_Information : RootFragement(R.layout.fragment_frag__check__sensor__information) {
    override fun viewInit() {
        ...
        rootview.b1.setOnClickListener {
            JzActivity.getControlInstance().changePage(Frag_Check_Sensor_Read(), "Frag_Check_Sensor_Read", true)
        }
        rootview.b2.setOnClickListener {
            JzActivity.getControlInstance().changePage(Frag_Check_Location(), "Frag_Check_Location", true)
        }
    }
