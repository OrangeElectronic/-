...
public class PowerUtil {
    ...
    public static void resetLight(Context ctx, int light) {
        try {
            ...
            Method asInterface = Stub.getMethod("asInterface", IBinder.class);    //of this class?
            ...
            Method setBacklightBrightness = power.getClass().getMethod("setBacklightBrightness", int.class);
            setBacklightBrightness.invoke(power, light);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
