...
public class SettingShare {
    ...
    public static void setArea (Context context, AreaUnitEnum area) {
        SharedPreferencesUtils.setParam(context, Area, area.ordinal());
    }
    ...
    public static void setAutoLockTimeout (Context context, TimeOutUnitEnum timeout) {
        SharedPreferencesUtils.setParam(context, AutoLockTimeout, timeout.ordinal());
    }
    ...
    public static Information getSystemInformation (Context context) {
        ...
        info.dataVersion = profilePreferences.getString("mmyname","MMY_EU_list_V0.5_191113").substring(12).replace(".db","");
        return info;
    }
    ...
    public enum NumeralSystemUnitEnum {
        Auto, Dec, Hex;
    ...
    public enum TirePressureUnitEnum {
        Psi, Bar, Kpa;
