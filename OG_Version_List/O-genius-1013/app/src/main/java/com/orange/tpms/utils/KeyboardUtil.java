...
import com.orango.electronic.orange_og_lib.Util.Util_ClearEditText;
...
public class KeyboardUtil {
     ...
     * 隐藏软键盘
     */
    public static void hideEditTextKeyboard(Util_ClearEditText editText){
        Class<Util_ClearEditText> cls = Util_ClearEditText.class;
        Method method;
        try {
