...
import com.orango.electronic.orange_og_lib.HttpCommand.Fuction.AddIfNotValid
import com.orango.electronic.orange_og_lib.PublicBean
import com.orange.tpms.ue.activity.KtActivity
import com.orange.tpms.utils.FormatConvert.*
...
//    F5FE10001FD0002B030108073ED96427E21E00B0002B030108073ED96427E21E01E5FD0A
    ...
    //                        @Override
    //                        public void run() {
    //                            act.LoadingUI(act.getResources().resources!!.jzString(R.string.update), 100);
    //                        }
    //                    });
    //                    return true;
    //                }else{
    ...
    //                        @Override
    //                        public void run() {
    //                            act.LoadingUI(act.getResources().resources!!.jzString(R.string.update), (int)((finalI / finalLong)*100));
    //                        }
    //                    });
