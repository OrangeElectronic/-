 ...
 */
public class CarWidget extends RelativeLayout {
    ...
    private void setStatus(CAR_STATUS status, ImageView imageView, TextView textView){
        ...
        }else if(status == CAR_STATUS.NOTINIT){
            imageView.setBackgroundResource(R.mipmap.iv_car_wheel);
            textView.setBackgroundResource(R.mipmap.icon_tire_cancel);
        }else if(status == CAR_STATUS.SELECT){
            imageView.setBackgroundResource(R.mipmap.icon_wheel_select);
            textView.setBackgroundResource(R.mipmap.yellow_tire);
        }
    }
}
