...
class Frag_Check_Location : RootFragement(R.layout.fragment_frag__check__location) {
    ...
    override fun viewInit() {
        ...
        rootview.tv_content.text = "${PublicBean.selectMmy.make}/${PublicBean.selectMmy.model}/${PublicBean.selectMmy.year}"
    }
        ...
        Thread {
            ...
            handler.post {
                ...
                if (a.success) {
                    ...
                    JzActivity.getControlInstance().toast(resources!!.jzString(R.string.app_read_failed))
                }
            }
        }.start()
    }
