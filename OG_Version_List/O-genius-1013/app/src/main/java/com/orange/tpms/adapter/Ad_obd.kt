...
class Ad_obd(public val beans: ObdBeans, var frag: Frag_Function_OBD_ID_copy) :
    ...
    var focus = if (PublicBean.position == PublicBean.複製傳感器) 0 else 1
    var position = 0
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (isDex && beans.NewSensor[position].id.isNotEmpty() && PublicBean.position == PublicBean.OBD_RELEARM) {
