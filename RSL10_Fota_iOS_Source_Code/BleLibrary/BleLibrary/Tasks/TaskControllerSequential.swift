...
public class TaskControllerSequential
{
    ...
    var taskPending: TaskProtocol?
    {
        ...
        set {
//            NSLog("TP: TaskPending is set[\(_taskPending?.description) >>> \(newValue?.description)]")
...
//                        NSLog("TP: taskThread -> get task from queue: \(taskPending?.description)")
                    }
                }
                ...
                if taskPending != nil
                {
                    ...
                    do
                    {
//                       NSLog("TP: taskThread --> Task started: \(taskPending)")
    ...
    {
//        NSLog("TP: onTaskCompleat --->: \(task.description)")
