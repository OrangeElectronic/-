...
//        NSLog("TempPrint: DR outFrame data: 0x\(BinaryString.toString(buffer: (outFrame?.toArray())!))")
...
//        NSLog("TempPrint: buffer [0x\(BinaryString.toString(buffer: buffer.toArray()))]")
    ...
    {
//        NSLog("FC- fotaFrameHandlerOnReciedData: \(BinaryString.toString(buffer: args.data.toArray()))")
    ...
    {
//        NSLog("FC- onDataNotificationReceived: \(BinaryString.toString(buffer: args.data.toArray()))")
