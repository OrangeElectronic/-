...
public class Glitter_BLE:BleCallBack{
    ...
    open func scanBack(_ device: CBPeripheral, advertisementData: [String : Any], rssi RSSI: NSNumber) {
        ...
        print("typeOF:\(type(of: advertisementData["kCBAdvDataServiceUUIDs"]))")
        
//        if(advertisementData["kCBAdvDataServiceUUIDs"] is NSArray){
//            advertisementData["kCBAdvDataServiceUUIDs"].map({
//                
//            })
//            print("kCBAdvDataServiceUUIDs->Array")
//        }
//        
