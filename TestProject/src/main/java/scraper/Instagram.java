...
import scraper.exception.InstagramAuthException;
import scraper.mapper.Mapper;
import scraper.mapper.ModelMapper;
...
public class Instagram implements AuthenticatedInsta {
    ...
    public static final PageInfo FIRST_PAGE = new PageInfo(true, "");
    ...
    public void getCSRFToken(ResponseBody body) throws IOException {
    ...
    public void getRolloutHash(ResponseBody body){
    	try {
    ...
    public String getToken(String seek, int length ,InputStream stream) throws IOException {
    ...
    public void markActivityChecked(ActivityFeed activityFeed) throws IOException {
        Request request = new Request.Builder()
