...
public class ModelMapper implements Mapper{
    ...
    public static final String AUTHENTICATED_FIELD = "authenticated";
    public final ThreadLocal<ObjectMapper> mapperThreadLocal = ThreadLocal.withInitial(ObjectMapper::new);
    @Getter(AccessLevel.PROTECTED)
    public final ConcurrentHashMap<String, ThreadLocal<Unmarshaller>> unmarshallerCache = new ConcurrentHashMap<>();
    ...
    public void updateMediaTime(Media media) {
    ...
    public void updateCommentTime(Comment comment) {
    ...
    public Node getDomModel(InputStream jsonStream) throws java.io.IOException {
