...
function getLeft(a) {
    switch (a) {
        case 'N_2':
            return `
<div style="width: calc(50% - 72px);position: relative;">
<table style="margin-top:0px;transform: translateY(30px);top:0;right:0;margin-right:-100px;position: absolute;"><tr><td><div class="select" id="n1">1</div></td></tr></table>
</div>
`
        case "R_4":
...
function getRight(a) {
    switch (a) {
        case 'N_2':
            return `
            <div style="width: calc(50% - 72px);position: relative;">
<table style="margin-top:0px;transform: translateY(310px);top:0;margin-left:-100px;position: absolute;left: 0;"><tr><td><div class="select" id="n2">2</div></td></tr></table>
</div>
            `
        case "R_4":
