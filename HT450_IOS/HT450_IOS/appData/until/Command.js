                    ...
                    if (rx.length >= rxSize) {
                        ...
                        for (var i = 0; i < (rx.length / rxSize); i++) {
                            ...
                            if ((rxText20.substring(0, 6) === '53FD'+Car) && (rxText20.substring(rxSize-2, rxSize) === '0A')){
                                ...
                                callback(rx_text.substring(0,10))
                                clearInterval(timer)
                            }
                        }
                    }
            ...
            try {
                ...
                var timer = setInterval(function () {
                    ...
                    if (rx.length >= rxSize) {
                        ...
                        for (var i = 0; i < (rx.length / rxSize); i++) {
                            var rxText20 = rx.substring(rxSize * i, rxSize + rxSize * i)
                            if (rxText20.substring(2, 4) === "B0" && rxText20.substring(rxSize-2, rxSize) === "0A") {
                                //確認資料
                                glitter.command.send("設定車ID",rxText20.replace("B0","C1"))
                                callback(true)
                                clearInterval(timer)
                                break
                            }
            ...
            try {
                ...
                var timer = setInterval(function () {
                    ...
                    if (rx.length >= rxSize) {
                        ...
                        for (var i = 0; i < (rx.length / rxSize); i++) {
                            var rxText20 = rx.substring(rxSize * i, rxSize + rxSize * i)
                            if (rxText20.substring(2, 4) === "BB" && rxText20.substring(rxSize-2,rxSize) === "0A") {
                                callback(rxText20.substring(6, 14))
                                clearInterval(timer)
                            }
                        }
            ...
            var timer = setInterval(function() {
                ...
                try {
                    ...
                    if (rx.length >= rxSize) {
                        for (var i = 0; i < (rx.length / rxSize); i++) {
                            var rxText20 = rx.substring(rxSize * i, rxSize + rxSize * i)
                            if(rxText20.substring(2,4)==="BA" && rxText20.substring(rxText20.length-2,rxText20.length)==="0A"){
                                //確認資料
                                glitter.command.send("設定輪軸",rxText20.replace("BA","C1"))
                                callback(true)
                                clearInterval(timer)
                                break
                            }
                ...
                var timer = setInterval(function () {
                    ...
                    if (rx.length >= rxSize) {
                        ...
                        for (var i = 0; i < (rx.length / rxSize); i++) {
                            ...
                            switch (glitter.app){
                                case "HT471A":
                                    if (rxText20.substring(2, 4) === "B1" && rxText20.substring(rxSize-2, rxSize) === "0A") {
                                        callback(true)
                                        clearInterval(timer)
                                    }
                                    break
                                default:
                                    if (rxText20.substring(2, 4) === "B2" && rxText20.substring(rxSize-2, rxSize) === "0A") {
                                        //確認資料
                                        glitter.command.send("設定SensorID",rxText20.replace("B2","C1"))
                                        callback(true)
                                        clearInterval(timer)
                                    }
                                    break
                ...
                var timer = setInterval(function () {
                    ...
                    if (rx.length >= rxSize) {
                        for (var i = 0; i < (rx.length / rxSize); i++) {
                            ...
                            switch (glitter.app){
                                case "HT471A":
                                    if (!start && rxText20.substring(0, 4) === "53D5" && rxText20.substring(rxSize-2, rxSize) === "0A") {
                                        start=true
                                    ...
                                    if (start && rxText20.substring(0, 4) === "53E1" && rxText20.substring(rxSize-2, rxSize) === "0A") {
                                        callback(rxText20.substring(6, 12))
                                        clearInterval(timer)
                                    }
                                    break
                                default:
                ...
                try {
                    if (rx.length >= rxSize) {
                        for (var i = 0; i < (rx.length / rxSize); i++) {
                            var rxText20 = rx.substring(rxSize * i, rxSize + rxSize * i)
                            //DB
                            if ((rxText20.substring(2, 4) === 'DA') && (rxText20.substring(rxText20.length - 2, rxText20.length) === '0A')) {
                                callback(true)
                                clearInterval(timer)
                            }
                ...
                try {
                    if (rx.length >= rxSize) {
                        for (var i = 0; i < (rx.length / rxSize); i++) {
                            var rxText20 = rx.substring(rxSize * i, rxSize + rxSize * i)
                            //DB
                            if((rxText20.substring(2, 4) === 'B3') && (rxText20.substring(rxText20.length - 2, rxText20.length) === '0A')){
                                //確認資料
                ...
                try {
                    ...
                    if (rx.length >= rxSize) {
                        for (var i = 0; i < (rx.length / rxSize); i++) {
                            ...
                            // }if(Car==="02"){
                            rxData=rxText20.substring(2,6)==="B9"+Car && rxText20.substring(rxText20.length-2,rxText20.length)==="0A"
                            //}
                            if(rxData) {
                                //if(rx.substring(2,4)==="DD" && rx.substring(rx.length-2,rx.length)==="0B") {
                                var R_Text = rxText20.substring(0,rxSize)
                                var H_Temp=0
                                var H_Pre=0
                                var L_Pre=0
                                switch (glitter.app){
            ...
            var timer = setInterval(function() {
                ...
                try {
                    ...
                    if (rx.length >= rxSize) {
                        for (var i = 0; i < (rx.length / rxSize); i++) {
                            var rxText20 = rx.substring(rxSize * i, rxSize + rxSize * i)
                            if(rxText20.substring(2,4)==="B8" && rxText20.substring(rxText20.length-2,rxText20.length)==="0A"){
                                //確認資料
                                glitter.command.send("設定警報值",rxText20.replace("B8","C1"))
                                callback(true)
                                clearInterval(timer)
                            }
                        }
            ...
            try {
                ...
                var timer = setInterval(function () {
                    ...
                    if (rx.length >= rxSize) {
                        ...
                        for (var i = 0; i < (rx.length / rxSize); i++) {
                            var rxText20 = rx.substring(rxSize * i, rxSize + rxSize * i)
                            if (rxText20.substring(2, 4) === "BF" && rxText20.substring(rxSize - 2, rxSize) === "0A") {
                                callback(rxText20.substring(4, 6))
                                clearInterval(timer)
                            }
                        }
                    }
                ...
                var timer = setInterval(function () {
                    ...
                    if (rx.length >= rxSize) {
                        ...
                        for (var i = 0; i < (rx.length / rxSize); i++) {
                            var rxText20 = rx.substring(rxSize * i, rxSize + rxSize * i)
                            //if(rx.substring(2,4)==="BB" && rx.substring(rx.length-2,rx.length)==="0A"){
                            if (rxText20.substring(2, 4) === "F4" && rxText20.substring(rxSize-2, rxSize) === "0A") {
                                callback(rxText20.substring(4, 6))
                                clearInterval(timer)
                            }
                        }
                ...
                var timer = setInterval(function () {
                    ...
                    if (rx.length >= rxSize) {
                        for (var i = 0; i < (rx.length / rxSize); i++) {
                            ...
                            //console.log("command.rx:" + rx)
                            //if(rx.substring(2,4)==="BB" && rx.substring(rx.length-2,rx.length)==="0A"){
                            if (rxText20.substring(2, 4) === "E7" && rxText20.substring(rxSize - 2, rxSize) === "0A") {
                                callback(true)
                                clearInterval(timer)
                            }
                        }
                ...
                var timer = setInterval(function () {
                    ...
                    if (rx.length >= rxSize) {
                        for (var i = 0; i < (rx.length / rxSize); i++) {
                            ...
                            //console.log("command.rx:" + rx)
                            //if(rx.substring(2,4)==="BB" && rx.substring(rx.length-2,rx.length)==="0A"){
                            if (rxText20.substring(0, 6) === "53F0" + Car && rxText20.substring(rxSize-2, rxSize) === "0A") {
                                callback(true)
                                clearInterval(timer)
                            }
                        }
                ...
                var timer = setInterval(function () {
                    ...
                    if (rx.length >= rxSize) {
                        for (var i = 0; i < (rx.length / rxSize); i++) {
                            ...
                            //console.log("command.rx:" + rx)
                            //if(rx.substring(2,4)==="BB" && rx.substring(rx.length-2,rx.length)==="0A"){
                            if (rxText20.substring(0, 8) === "53BF"+Car+open && rxText20.substring(rxSize-2, rxSize) === "0A") {
                                callback(true)
                                clearInterval(timer)
                            }
                        }
